...
// to use loading Skeleton everywhere , I copy and paste all jsx and replace it everywhere where I have dynamic values(anything what has to load it's value)
